...
.mm{
  margin:30px;
    ...
    <div class="card2">
        <img class="mm"id="image" src="{{ asset($course->image_path) }}" alt="College Image" width="200" height="200">
        <div class="container">
            <h4><p class="name" id="name" name="title">{{ $course->name }}</p></h4>
            <p><p class="DocName" id="DocName" name="title">{{ $course->DocName }}</p></p>
        </div>
    </div>
    <form action="{{ route('courses.store') }}" method="POST">
          ...
          <input type="hidden" name="DocName" value="{{ $course->DocName }}">
          <input type="hidden" name="image_path" value="{{ asset($course->image_path) }}">
