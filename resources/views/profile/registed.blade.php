...
.mm{
  margin:30px;
    ...
    <div class="card2">
        <img class="mm"id="image" src="{{ asset($registered_course->image_path) }}" alt="College Image" width="200" height="200">
        <div class="container">
            <h4><p class="name" id="name" name="title">{{ $registered_course['name'] }}</p></h4>
            <p><p class="DocName" id="DocName" name="title">{{ $registered_course['DocName'] }}</p></p>
        </div>
    </div>
@endforeach
</div>
