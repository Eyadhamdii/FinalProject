...
@media (max-width: 420px) {
  .sidebar li .tooltip{
      ...
      <ul class="nav-list">
        ...
        <li class="profile">
          ...
          <form action="{{ route('logout') }}" method="POST">
                @csrf
                <button type="submit"><a href =""><i class="bx bx-log-out" id="log_out"></i></a></button>
          </form>
    ...
    <div class="container">
        <span class="text first-text" style="color:black;">Welcome Doctor:</span>
        <span class="text sec-text">{{ $name }}</span>
    </div>
    <div class="heading">
				
				<div class="btns">
					<a class="btn1" href="profile">MY PROFILE</a>
					<a class="btn1" href="{{Route("Procourses.index")}}">MY COURSES</a>
				</div>
