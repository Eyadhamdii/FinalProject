...
margin-top:20px;
  ...
  <div class="FormLogin">
    <form class="froms" method="POST" action="{{ route('register') }}">
      ...
      <div class="mb-3">
        <label for="username">Uni ID</label>
        <input name="UniId" id="National ID" type="username" class="form-control">
      </div>
      <div class="mb-3">
        <label for="username">National ID</label>
        <input name="NationalId" id="National ID" type="username" class="form-control">
      </div>
      <div class="mb-3">
        <label for="username">Mobile</label>
        <input name="Mobile" id="National ID" type="username" class="form-control">
      </div>
      <p class="pp">Choose Your Gender:</p>
      <div class="fle">
        <div class="ffd">
          <div class="rrr"><input type="radio" name="gender" value="male"></div>
          <label class="mm" for="Male">Male</label><br>
          <div class="rr"><input type="radio" name="gender" value="female"></div>
          <label class="mm"  for="Female">Female</label><br>
        </div>
      </div>
      <p class="pp">Choose Your Role:</p>
		<div class="fle">
		<div class="ffd">
			<div class="rrr"><input type="radio" name="role" value="Doctor"></div>
...
  		<label class="mm"  for="Student">Student</label><br></div></div>
      ...
      <div class="row mb-0">
        <div class="col-md-6 offset-md-4">
          <button type="submit" class="bbt">Sign up</button>
        </div>
      </div>
    </form>
  </div>
